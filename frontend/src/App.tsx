...
import "./styles/institution/InstitutionTheme.css";
...
import InstitutionInstructorsPage from "./pages/institution/Instructors.page";
...
import CourseListPage from "./pages/institution/Courses.page";
  ...
  return (
    <>
      ...
      <Routes>
        ...
        />
        <Route
          path="/student/dob/verification/:id"
          element={
            <RestrictRoute>
              <DobVerificationPage />
            </RestrictRoute>
        ...
        />
        <Route
          path="/institution/onboarding/:id"
          element={
            <ProtectRoute>
              <RestrictInstitutionRoute>
                <InstitutionOnboardingPage />
              </RestrictInstitutionRoute>
            </ProtectRoute>
          }
        />
        <Route
          path="/institution/requests/:id"
          element={
            <ProtectRoute>
              <RestrictInstitutionRoute>
                <RequestStatusPage />
