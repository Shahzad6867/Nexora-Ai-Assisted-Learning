...
import {
  formatDate,
  formatTime,
} from "../../utilities/formatDateAndTime.utility";
...
export default function InstitutionDetailPage() {
  ...
  const [institution, setInstitution] = useState<InstitutionRecord | null>(
    null
  );
  ...
  async function handleStatusChange(next: RequestStatusKey, note: string) {
    ...
    try {
      const response = await api.put(`/admin/requests/${request.request_id}`, {
        status_type: next,
        status_note: note,
      });
    ...
    <AdminLayout title={institution.institution_name}>
        ...
        <div className="detail-hero-left">
          ...
          <div>
            ...
            <div className="detail-hero-badges">
              <span
                className={`status ${
                  institution.isVerified ? "status-active" : "status-pending"
                }`}
              >
      ...
      <div className="panel">
        ...
        <p className="panel-subtitle">
          Core institution details submitted during onboarding.
        </p>
        <DetailGrid
          items={[
            { label: "Institution Name", value: institution.institution_name },
            {
              ...
              value: institution.institution_email,
            },
            {
              label: "Year Established",
              value: institution.year_established
                ? new Date(institution.year_established)
                    .getFullYear()
                    .toString()
                : "",
            },
            { label: "Official Website", value: institution.official_website },
            {
              ...
              value: institution.institution_logo || "Not uploaded",
            },
          ]}
        />
        {institution.description && (
          <div style={{ marginTop: 15 }} className="detail-item">
            ...
            <strong style={{ fontWeight: 400, lineHeight: 1.6 }}>
              {institution.description}
            </strong>
          </div>
        )}
      ...
      {institution.primary_contact && (
        <div className="panel">
          ...
          <p className="panel-subtitle">
            The official person responsible for this institution on Nexora.
          </p>
          <DetailGrid
            items={[
              {
                label: "Person Name",
                value: institution.primary_contact.person_name,
              },
              {
                label: "Designation",
                value: institution.primary_contact.designation,
              },
              {
                label: "Official Email",
                value: institution.primary_contact.official_mail,
              },
              {
                label: "Phone Number",
                value: institution.primary_contact.phone_number,
              },
              {
                label: "Alternate Phone",
                value: institution.primary_contact.alternate_phone_number,
              },
            ]}
          />
        </div>
      ...
      {institution.address && (
        <div className="panel">
          ...
          <p className="panel-subtitle">
            Registered physical address of the institution.
          </p>
          <DetailGrid
            items={[
              ...
              {
                label: "Full Address",
                value: institution.address.full_address,
              },
            ]}
          />
        </div>
            ...
            items={[
              {
                ...
                value: institution.legal_information.legal_organization_name,
              },
              {
                label: "Registration Number",
                value: institution.legal_information.registration_number,
              },
              {
                label: "Registration Authority",
                value: institution.legal_information.registration_authority,
              },
              {
                label: "Tax Identification Number",
                value: institution.legal_information.tax_identification_number,
              },
              {
                label: "Accreditation Body",
                value: institution.legal_information.accreditation_body,
              },
              {
                label: "Legal Document",
                value:
                  institution.legal_information.legal_document ||
                  "Not uploaded",
              },
            ]}
          />
      ...
      {institution.bank_information && (
        <div className="panel">
          ...
          <p className="panel-subtitle">
            Payout account details for this institution.
          </p>
          <DetailGrid
            items={[
              {
                label: "Legal Organization Name",
                value: institution.bank_information.legal_organization_name,
              },
              {
                label: "Bank Name",
                value: institution.bank_information.bank_name,
              },
              {
                label: "Account Number",
                value: institution.bank_information.account_number,
              },
              {
                label: "SWIFT Code",
                value: institution.bank_information.swift_code,
              },
              {
                label: "IBAN Number",
                value: institution.bank_information.iban_number,
              },
            ]}
          />
        </div>
      ...
      <div className="panel">
        ...
        <p className="panel-subtitle">
          Consents accepted by the institution during onboarding.
        </p>
        <div className="compliance-row">
          <span
            className={`compliance-chip ${
              institution.terms_acceptance ? "yes" : "no"
            }`}
          >
          ...
          <span
            className={`compliance-chip ${
              institution.policy_acceptance ? "yes" : "no"
            }`}
          >
          ...
          <span
            className={`compliance-chip ${
              institution.educational_consent ? "yes" : "no"
            }`}
          >
      ...
      {request && (
        <div className="panel">
          <h2 className="panel-title">
            {request.request_type || "Onboarding Request"}
          </h2>
          <p className="panel-subtitle">
            {request.request_id} · Submitted by {institution.institution_name}{" "}
            on {formatDate(request.submitted_on)}
          </p>
