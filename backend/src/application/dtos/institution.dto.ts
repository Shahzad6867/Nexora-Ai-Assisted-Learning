...
export interface GetInstitutionAndRequestResponseDTO {
  institution: IInstitutionDocument | null;
  request: IRequestDocument | null;
}

export interface BlockOrUnblockDTO {
  isBlocked: boolean;
}

export interface getInstitutionsResponseDTO {
